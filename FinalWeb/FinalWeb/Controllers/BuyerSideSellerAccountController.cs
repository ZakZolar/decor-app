...
{
    public class BuyerSideSellerAccountController : Controller
    {
        //
        // GET: /BuyerSideSellerAccount/
        ...
        public ActionResult Login(FormCollection formColl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (cust != null)
                {
                    ...
                    return RedirectToAction("Login", "BuyerSideSellerAccount",routeValues);
                    //change action/controller/parameters
                }
