...
{
    public class ForBuyerCheckOutController : Controller
    {
        DecorFinalWebEntities2 db=new DecorFinalWebEntities2();
        //
        // GET: /ForBuyerCheckOut/
        ...
        {            
                ...
                Order o = new Order();
                o.OrderID = orderID;
                o.CustomerID = ShippingData.UserID;
                o.PaymentID = payID;
                o.ShippingID = shpID;
                ...
                foreach (var OD in ShippingData.items)
                {
                    OD.OrderID = orderID;
                ...
                return RedirectToAction("Voucher","ForBuyerThankYou");
